...
export function ApproachSection() {
  return (
    <Section container={false} className="bg-background py-20 md:py-40">
      <div>
        <Container>
            ...
            <div className="flex flex-col gap-16 md:gap-32 pb-16 md:pb-32">
              {steps.map((step) => (
                ...
                >
                  ...
                  <div className="absolute -top-10 md:-top-16 -left-4 md:-left-8 text-[80px] md:text-[150px] font-black text-primary/[0.05] select-none pointer-events-none leading-none tracking-normal transition-colors duration-500 group-hover:text-primary/[0.08]">
                    {step.num}
                  </div>
                  ...
                  <div className="relative z-10 pt-2">
                    <div className="flex items-center gap-3 md:gap-4 mb-3 md:mb-4">
                      ...
                      <h3 className="text-2xl md:text-4xl font-bold text-primary tracking-normal group-hover:text-secondary transition-colors duration-300">
                        {step.title}
                      </h3>
                    </div>
