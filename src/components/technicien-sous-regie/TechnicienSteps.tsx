                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
                    ...
                    <div className="lg:col-span-5 relative">
                        <div className="lg:sticky lg:top-[25vh]">
                            ...
                            <h2 className="text-3xl sm:text-5xl lg:text-7xl font-black text-foreground leading-tight">
                                Comment ça se passe, <br />
                                <em className="not-italic text-secondary-strong">du premier appel au premier jour ?</em>
                            </h2>
