...
export function SerenitePricing() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div className="p-8 rounded-2xl bg-[#dce7f2] border border-secondary/20 space-y-6">
        <div className="flex justify-between items-baseline">
          <span className="text-lg font-bold text-primary">Mensuel</span>
          <span className="text-2xl font-black text-secondary">79€ HT <span className="text-sm font-normal text-primary/50">/ poste / mois</span></span>
        </div>
      ...
      <div className="p-8 rounded-2xl bg-[#dce7f2] border border-secondary/20 space-y-6 relative overflow-hidden">
        ...
        <div className="flex justify-between items-baseline">
          ...
          <span className="text-2xl font-black text-secondary">869€ HT <span className="text-sm font-normal text-primary/50">/ poste / an</span></span>
        </div>
        <ul className="text-base text-primary/70 space-y-3">
          <li className="flex items-center gap-3">
            <span className="w-1.5 h-1.5 rounded-full bg-secondary shrink-0" />
