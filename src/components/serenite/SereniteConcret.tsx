          ...
          <div className="relative z-10 w-full lg:w-[55%] p-10 lg:p-20 h-full flex flex-col justify-center">
            ...
            <div className="space-y-6 mb-12">
              <h2 className="text-3xl md:text-5xl font-extrabold text-white leading-tight">
                Ce qu&apos;on fait que les autres <br/> <span className="text-secondary-soft">ne font pas</span>
              </h2>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <svg 
                         className={`w-6 h-6 transform transition-transform duration-500 ${isActive ? "rotate-180 text-secondary-soft" : "text-white/40"}`} 
                        fill="none" 
                        viewBox="0 0 24 24" 
                        stroke="currentColor"
                      >
