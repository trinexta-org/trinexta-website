  ...
  return (
    <div className="grid grid-cols-3 gap-2 sm:gap-8 max-w-5xl mx-auto w-full">
      {stats.map((stat, index) => (
        ...
        >
          <div className="text-2xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-white tracking-normal mb-2 md:mb-6 transition-transform duration-500 group-hover:scale-105 group-hover:text-secondary-strong">
          ...
          <div className="space-y-1 md:space-y-3 w-full flex flex-col items-center">
            ...
            <h3 className="text-[9px] sm:text-xs md:text-base font-bold text-secondary-strong uppercase tracking-[0.05em] md:tracking-[0.2em] leading-tight mt-2">
              {stat.title}
            </h3>
