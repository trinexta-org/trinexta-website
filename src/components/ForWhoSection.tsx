                  ...
                  >
                    <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3 md:gap-4">
                      <div className="flex-1">
                        <Heading as="h3" className="text-lg md:text-3xl font-bold mb-1 md:mb-2 leading-tight text-balance text-primary-foreground">
                          <LightSweepText delay={index * 0.5}>{target.title}</LightSweepText>
                        </Heading>
                        <Text className="text-[11px] md:text-base leading-relaxed max-w-lg text-primary-foreground">
                          <LightSweepText delay={index * 0.5 + 0.3}>{target.description}</LightSweepText>
                        </Text>
                      </div>
