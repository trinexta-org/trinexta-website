      ...
      <Container className="relative z-10 text-center">
        <div className="space-y-8 md:space-y-16">
          ...
          <Text className="text-white/70 text-base md:text-xl font-light max-w-3xl mx-auto leading-relaxed">
            Donnez une nouvelle impulsion à votre support IT. <br className="hidden md:block" />
            <span className="text-white font-medium italic">Nous vous aidons à surmonter vos défis technologiques.</span>
          </Text>
