    ...
    >
      ...
      <Container className="relative z-10 text-center px-4">
        {surtitle && (
          <FadeIn
            direction="up"
            className="text-secondary-strong text-sm md:text-base font-bold tracking-[0.2em] mb-4 md:mb-6 block"
          >
            {surtitle}
          </FadeIn>
        )}
        ...
        <FadeIn direction="up" delay={0.1}>
          <Heading as="h2" className="text-4xl md:text-6xl lg:text-7xl font-black text-primary tracking-normal leading-none">
            {line1} <br /> <span className="text-secondary-strong">{line2}</span>
          </Heading>
        </FadeIn>
