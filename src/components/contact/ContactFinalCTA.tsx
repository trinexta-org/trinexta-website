  ...
  return (
    <div className="absolute inset-0 z-0 flex items-center justify-center opacity-70 pointer-events-none overflow-hidden w-full">
      <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent_0%,black_15%,black_85%,transparent_100%)] w-full h-full">
        <svg className="w-[120%] h-full -ml-[10%]" viewBox="0 0 1200 800" preserveAspectRatio="none">
          <defs>
            <linearGradient id="grad-fiber-primary" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="transparent" stopOpacity="0" />
              <stop offset="50%" stopColor="var(--secondary)" stopOpacity="0.6" />
              <stop offset="100%" stopColor="transparent" stopOpacity="0" />
            </linearGradient>
            <linearGradient id="grad-fiber-white" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="transparent" stopOpacity="0" />
              <stop offset="50%" stopColor="var(--primary-foreground)" stopOpacity="0.4" />
              <stop offset="100%" stopColor="transparent" stopOpacity="0" />
            </linearGradient>
          </defs>
...
export function ContactFinalCTA() {
  ...
  const part1Animation: TargetAndTransition = {
    ...
    transition: { duration: 8, times: [0, 0.5, 0.75, 1], repeat: Infinity, ease: "linear" }
  };

  const part2Animation: TargetAndTransition = {
    color: [white, sec, sec, white],
    transition: { duration: 8, times: [0, 0.25, 0.75, 1], repeat: Infinity, ease: "linear" }
  };
    ...
    <Section container={false} className="relative bg-primary overflow-hidden py-24 md:py-48">
      ...
      <Container className="relative z-10 text-center">
        <div className="space-y-8 md:space-y-16">
          <Heading as="h2" className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl text-white uppercase tracking-tighter leading-[0.9] flex flex-col items-center font-black">
          ...
          <Text className="text-white/70 text-base md:text-xl font-light max-w-3xl mx-auto leading-relaxed">
            Trinexta by Trustech IT Support simplifie et sécurise votre informatique. <br className="hidden md:block" />
            <span className="text-white font-medium italic">Un accompagnement fiable, souple et adapté à votre performance.</span>
          </Text>
          <div className="pt-4 md:pt-6">
            ...
            >
              ...
              <span className="relative z-10 text-white group-hover:text-primary font-black text-xs md:text-sm uppercase tracking-[0.15em] md:tracking-[0.2em] transition-colors duration-500">
                En savoir plus
              </span>
