...
export function NewsletterCTA() {
  ...
  return (
    <section className="relative w-full py-16 md:py-24 border-t border-primary/10 bg-background overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            <h2 className="text-3xl md:text-4xl font-black text-primary mb-4">
              Ne manquez aucune <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary to-primary">Actualité</span>
            </h2>
            ...
            <form onSubmit={handleSubmit} className="relative flex flex-col gap-4">
              <div className="relative">
                <input
                  ...
                  className="w-full bg-white border border-primary/20 text-primary placeholder:text-muted-foreground rounded-2xl px-6 py-4 pr-16 focus:outline-none focus:border-secondary focus:ring-1 focus:ring-secondary transition-all disabled:opacity-50 shadow-sm"
                />
                <button
                  type="submit"
              ...
              {/* Messages de retour */}
              {status === "success" && (
                <div className="flex items-center justify-center lg:justify-start gap-2 text-green-600 text-sm font-medium animate-in fade-in slide-in-from-bottom-2">
                  <CheckCircle2 className="w-4 h-4" />
                  <p>{message}</p>
                </div>
              )}
              {status === "error" && (
                <div className="flex items-center justify-center lg:justify-start gap-2 text-red-600 text-sm font-medium animate-in fade-in slide-in-from-bottom-2">
                  <AlertCircle className="w-4 h-4" />
                  <p>{message}</p>
                </div>
              )}
            </form>
            <p className="text-muted-foreground text-[11px] mt-4 text-center lg:text-left leading-relaxed">
