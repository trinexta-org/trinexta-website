...
import { urlForImage, formatDatePublication } from "@/lib/sanity";
...
export function BlogSection({ articles, categories, activeCategory, onCategoryChange }: BlogSectionProps) {
  ...
  return (
    <section className="relative bg-primary py-8 md:py-32 px-0 md:px-8"> 
          ...
          <AnimatePresence mode="popLayout">
            {articles.map((post) => (
              <motion.div
                ...
                viewport={{ amount: 0.5 }}
                className="relative aspect-video rounded-[40px] overflow-hidden group shadow-2xl border border-white/5"
              >
                <Image
